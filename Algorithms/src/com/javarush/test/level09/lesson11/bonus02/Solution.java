...
public class Solution
{
    public static void main(String[] args) throws IOException
    {
        ...
        {
            FileInputStream fileInputStream = new FileInputStream(sourceFileName);// Исходный файл
            FileOutputStream fileOutputStream = new FileOutputStream(destinationFileName);// куда копировать
