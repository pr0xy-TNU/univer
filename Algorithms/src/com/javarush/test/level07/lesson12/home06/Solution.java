...
public class Solution
{
    ...
    {
        Human grandPa1 = new Human("дед Василий", true, 80, null, null);
        Human grandPa2 = new Human("дед Иван", true, 75, null, null);

        Human grandMa1 = new Human("баба Параша", false, 73, null, null);
        Human grandMa2 = new Human("баба Настя", false, 64, null, null);
