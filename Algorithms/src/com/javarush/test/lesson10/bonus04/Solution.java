package com.javarush.test.lesson10.bonus04;
...
public class Solution extends AbstractList<String> implements List<String>, Cloneable, Serializable {
  ...
  /*  @Override
    ...
    public static void javisTest() throws CloneNotSupportedException, IOException, ClassNotFoundException, IOException {
