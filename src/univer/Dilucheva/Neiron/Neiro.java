package univer.Dilucheva.Neiron;


import univer.MyAwt.MainPanel;
...
public class Neiro {
    ...
    * */
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        BufferedWriter writerFile = new BufferedWriter(new FileWriter("D:/Programming/temp_txt/result.txt"));
        ...
        while (!isInterrupted) {
            ...
            if (incChecker >= 9) {
                isInterrupted = true;
                writerFile.write(String.format("%.2f %.2f %.2f", omega[0], omega[1], omega[2]));
            } else {
                incChecker = 0;
                writerFile.write(String.format("%.2f %.2f %.2f %n", omega[0], omega[1], omega[2]));
            }
            iterationCounter++;
