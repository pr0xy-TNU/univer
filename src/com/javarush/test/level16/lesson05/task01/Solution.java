...
public class Solution {
    ...
    public static class PrintListThread extends Thread // создает лист и присваивает ему нить
    {
    ...
    public static void printList(List<String> list, String threadName) // Выводит лист указанной нити
    {
    ...
    public static List<String> getList(int n) //Возвращает лист указанной размерности
    {
